...
```shell
git clone https://github.com/yahyae07/RM_IN_FL.git
```

This will create a new directory called `RM_IN_FL` containing the following files:

```shell
-- pyproject.toml
-- client.py # There is different client.py for each client (client1CNN.py, client2CNN.py, client3CNN.py, ...)
-- server.py
-- README.md
```
